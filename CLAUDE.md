...
**`TODO.md` 파일을 읽어주세요.** 현재 진행 중인 작업과 보류된 기능 개선사항이 정리되어 있습니다.

- **PDF 내보내기 기능 개선** (우선순위: 높음) - A4 너비 비율 문제 해결 필요
- 진행 상태와 기술적 배경을 TODO.md에서 확인한 후, 이번 세션에서 진행할 작업을 결정하세요.
...
<div style="animation:fuv .42s ease both;animation-delay:.XXs">
  <a href="tools/new-tool-name.html" class="tool-card" aria-label="도구명">
    ...
    <div class="tool-desc">한 줄 설명</div>
...
├── rules/
│   ├── git-rules.md                             # Git 커밋/브랜치 컨벤션
│   └── code-style.md                            # HTML/CSS/JS 코드 스타일 가이드
