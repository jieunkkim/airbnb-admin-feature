...
- [ ] 파일 로드 (콘솔 에러 확인)
- [ ] 토스트 메시지 표시
- [ ] 숫자 포매팅 (예: 1000000 → 1,000,000)
- [ ] HTML 이스케이프 (특수문자 안전성)
- [ ] 카테고리 색상 조회

### **Step 2: Data-Calculator 분리 후**
- [ ] 파일 로드
- [ ] KPI 계산 정확도 (수입/지출 합계)
- [ ] 카테고리별 집계 (개수, 금액)
- [ ] 필터링 (연도, 월)
...
**2026-04-14 작성**
- [ ] Step 1 (Utils): 계획 수립
- [ ] Step 2 (Data-Calculator): 계획 수립
- [ ] Step 3 (Chart-Renderer): 계획 수립
- [ ] Step 4 (Rules-Manager): 계획 수립
- [ ] Step 5 (Report-Generator): 계획 수립
...
| 항목 | 현재 | 분리 후 | 감소 |
|------|------|--------|------|
| **HTML 파일** | 3,026줄 | ~1,200줄 | **1,826줄 (60%)** 🎉 |
| **총 라인 수** | 3,026줄 | 5개 파일 | 유지 (구조만 개선) |
| **평균 파일 크기** | 3,026줄 | ~600줄 | 가독성 ⬆️ |
| **유지보수성** | 낮음 | 높음 | 개선 ⬆️⬆️ |
